...
errs3 = get_error_area(result_MDA, 0.01, 0.5)
...
errs4 = get_error_area(result_MDA, 0.01, 0.375)
...
errs5 = get_error_area(result_MDA, 0.01, 0.25)
...
errs6 = get_error_area(result_MDA, 0.01, 0.125)
