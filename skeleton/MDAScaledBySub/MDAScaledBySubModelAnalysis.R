...
plot(test_nu_MDASub, errs[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.5), main = "Area under ErrorDiagram for tau > 0.01", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs2[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.01, 0.75)", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs3[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.01, 0.5)", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs4[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.01, 0.375)", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs5[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.01, 0.25)", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs6[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.01, 0.125)", xlab = 'nu', ylab = 'error rate')
...
plot(test_nu_MDASub, errs7[seq(1,231, 11)], cex = 0.5, pch = 19, type = 'b', col = alpha('green',0.7), main = "Area under ErrorDiagram for tau in range (0.3, 0.5)", xlab = 'nu', ylab = 'error rate')
